                ...
                >
                    <div className="w-full surface-card py-8 px-5 sm:px-8" style={{ borderRadius: '53px' }}>
                        ...
                        <div>
                            ...
                            <label htmlFor="roles" className="block text-900 font-medium text-xl mb-2">Cargos</label>
                            <Dropdown 
                            id="roles"
                            optionLabel="label"
                            value={usuario.roles} 
                            ...
                            <div className="flex align-items-center justify-content-between mb-5 gap-5">                                
                                ...
                                <a className="font-medium no-underline ml-2 text-right cursor-pointer" style={{ color: 'var(--primary-color)' }} onClick={() => router.push('/auth/verify')}>
                                    Verificar Cadastro!
                                </a>
                            </div>
